...
/// ConsumerStatefulWidget = StatefulWidget + ref（State 里随处可用）。
class V4ProductDetailPage extends ConsumerStatefulWidget {
  const V4ProductDetailPage({super.key, required this.product});

  final Product product;

  @override
  ConsumerState<V4ProductDetailPage> createState() =>
      _V4ProductDetailPageState();
}

class _V4ProductDetailPageState extends ConsumerState<V4ProductDetailPage> {
